...
// ─────────────────────────────────────────────────────────────────────────────
//  StrategyAPI: clean interface for strategies to interact with Tape
//
...
//
//  Exposes Tape to Python for research workflows.
//  Install:  pip install pybind11
//  Build:    cmake --build . --target tape_py
// ─────────────────────────────────────────────────────────────────────────────
...
PYBIND11_MODULE(tape_py, m) {
    m.doc() = "Tape Python bindings";
    ...
    // ── TapeSimulation ────────────────────────────────────────────────────
    py::class_<TapeSimulation>(m, "TapeSimulation")
        .def(py::init<SimulationConfig>())
        .def("run", &TapeSimulation::run);
}
*/

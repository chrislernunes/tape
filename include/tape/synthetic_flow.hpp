...
private:
    ...
    void generate_cancellations(Price /*bid*/, Price /*ask*/, double sim_ns) {
        // Poisson cancel *times* only. order_id stays 0; TapeSimulation
        // binds it to the live touch on that side at dispatch. Guessing
        // sequential ids cancelled the seed book or missed entirely.
